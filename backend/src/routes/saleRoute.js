...
import {getAllSales, getSalesWithProducts, createSale} from "../controllers/saleController.js"

const router = Router();

router.get("/", getAllSales); //Devuelve solo las ventas (sin detalles de productos).
router.get("/with-products", getSalesWithProducts); // -> Devuelve las ventas con los productos asociados.
